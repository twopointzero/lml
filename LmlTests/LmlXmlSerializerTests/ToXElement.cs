    ...
    public class ToXElement
    {
        ...
        public void GivenItemShouldProduceExpectedResult()
        {
            var item = new Item("Artist", "Title", 0.42, new DateTime(2009, 1, 1), 69, new DateTime(2010, 1, 1), "Genre",
                                @"C:\path\file.ext", TimeSpan.FromSeconds(74.001));
            var expected = Mother.CreateItemXElement("Artist", "Title", "0.42", "2009-01-01T00:00:00", "69",
        ...
        public void GivenLibraryShouldProduceExpectedResult()
        {
            var item1 = new Item("Artist1", "Title1", 0.421, new DateTime(2009, 1, 11), 691, new DateTime(2010, 1, 11),
                                 "Genre1", @"C:\path\file1.ext", TimeSpan.FromSeconds(741));
            var item2 = new Item("Artist2", "Title2", 0.422, new DateTime(2009, 1, 12), 692, new DateTime(2010, 1, 12),
                                 "Genre2", @"C:\path\file2.ext", TimeSpan.FromSeconds(742));
            var item3 = new Item("Artist3", "Title3", 0.423, new DateTime(2009, 1, 13), 693, new DateTime(2010, 1, 13),
                                 "Genre3", @"C:\path\file3.ext", TimeSpan.FromSeconds(743));
            var library = new Library("1.0", "Unit Tests", new[] { item1, item2, item3 });

            var expectedItem1 = Mother.CreateItemXElement("Artist1", "Title1", "0.421", "2009-01-11T00:00:00", "691",
                                                          "2010-01-11T00:00:00", "Genre1", @"C:\path\file1.ext", "741");
            var expectedItem2 = Mother.CreateItemXElement("Artist2", "Title2", "0.422", "2009-01-12T00:00:00", "692",
                                                          "2010-01-12T00:00:00", "Genre2", @"C:\path\file2.ext", "742");
            var expectedItem3 = Mother.CreateItemXElement("Artist3", "Title3", "0.423", "2009-01-13T00:00:00", "693",
