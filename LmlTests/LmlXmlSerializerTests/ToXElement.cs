...
namespace twopointzero.LmlTests.LmlXmlSerializerTests
{
    ...
    public class ToXElement
    {
        ...
        {
            var item = new Item("Artist", "Title", 0.42, 69, new DateTime(2010, 1, 1), "Genre", null);
        ...
        {
            var item1 = new Item("Artist1", "Title1", 0.421, 691, new DateTime(2010, 1, 11), "Genre1", null);
            var item2 = new Item("Artist2", "Title2", 0.422, 692, new DateTime(2010, 1, 12), "Genre2", null);
            var item3 = new Item("Artist3", "Title3", 0.423, 693, new DateTime(2010, 1, 13), "Genre3", null);
        ...
        {
            var item = new Item("Artist", "Title", 0.42, 69, new DateTime(2010, 1, 1), "Genre", @"C:\path\file.ext");
            var expected = Mother.CreateItemXElement("Artist", "Title", "0.42", "69", "2010-01-01T00:00:00", "Genre",
                                                     @"C:\path\file.ext");
            var actual = new LmlXmlSerializer().ToXElement(item);
            Assert.IsTrue(XNode.DeepEquals(expected, actual));
